...
import PaymentCellDetails from "@/components/deathcharity/PaymentCellDetails";
import { Select, SelectContent, SelectItem, SelectTrigger, SelectValue } from "@/components/ui/select";

const PAYMENT_TYPE = ['registration', 'yearly'];
const PAYMENT_METHODS = ['cash', 'fpx', 'bank_transfer', 'cheque', 'other'];

export default function PaymentForm({ memberId, payments = [], onSubmit, onCancel, selectedYear }) {
  let currentYear = selectedYear || new Date().getFullYear();
  ...
  return (
    <>
      <PaymentCellDetails payments={payments} year={selectedYear}/>
