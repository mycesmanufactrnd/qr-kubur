  ...
  return (
    <div className="relative flex items-center justify-center w-24 h-24 mx-auto mb-6">
      <div className="relative z-10 flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-br from-slate-200 to-slate-300 dark:from-slate-600 dark:to-slate-700 shadow-inner">
        <AlertCircle className="w-8 h-8 text-slate-400 dark:text-slate-500" strokeWidth={1.5} />
      </div>
        ...
        <CardContent className="px-7 pt-8 pb-7 text-center">
          ...
          <h3
            className={`text-base font-semibold tracking-tight mb-2 ${
              isNoGPS ? "text-orange-700 dark:text-orange-400" : "text-slate-700 dark:text-slate-200"
            }`}
          ...
          <p
            className={`text-sm leading-relaxed mb-0 ${
              isNoGPS ? "text-orange-500/80 dark:text-orange-400/70" : "text-slate-400 dark:text-slate-500"
            }`}
          >
            {displayDesc}
          </p>
          ...
          {isPage && (
            <div className="flex flex-wrap gap-2 justify-center mt-6">
              ...
              <Button
                ...
                className={`gap-1.5 rounded-xl text-xs font-medium border-0 ${
                  isNoGPS
                    ? "bg-gradient-to-r from-orange-400 to-rose-500 hover:from-orange-500 hover:to-rose-600 text-white"
