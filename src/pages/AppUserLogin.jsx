    ...
    <div className="min-h-screen flex items-center justify-center p-4">
      <Card className="w-full max-w-md shadow-xl dark:bg-gray-800">
        <CardHeader className="space-y-1 text-center">
          ...
          <CardTitle className="text-2xl font-bold dark:text-white">{translate('Admin Login')}</CardTitle>
          <p className="text-sm text-gray-500 dark:text-gray-400">{translate('Log in to access the admin dashboard')}</p>
        </CardHeader>
        <CardContent>
          <form onSubmit={onSubmit} className="space-y-4">
            ...
            <div className="space-y-2">
              <label className="text-sm font-medium dark:text-gray-200">{translate('Email')}</label>
              <Input
                type="email"
            ...
            <div className="space-y-2">
              <label className="text-sm font-medium dark:text-gray-200">{translate('Password')}</label>
