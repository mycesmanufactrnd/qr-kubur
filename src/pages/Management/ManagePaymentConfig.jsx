...
import MobileManagePaymentConfig from "@/pages/Mobile/ManagePaymentConfig";
...
function ManagePaymentConfigDesktop() {
    ...
    <div className="space-y-6">
      <Breadcrumb
        items={[
          ...
          { label: translate("Payment Config"), page: "ManagePaymentConfig" },
        ]}
      />
