      ...
      <div className="space-y-6">
        <Breadcrumb
          items={[
            ...
            {
              label: translate("Manage Islamic Events"),
          ...
          <div className="space-y-4 py-4">
              ...
              <div className="space-y-2">
                ...
                <select
                  ...
                  onChange={(e) =>
                    setFormData({
                      ...formData,
                      hijrimonth: parseInt(e.target.value),
                    })
                  }
                  className="w-full border rounded px-2 py-1"
                >
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setFormData({
                      ...formData,
                      hijriday: parseInt(e.target.value),
                    })
                  }
                />
              </div>
            ...
            <div className="space-y-2">
              ...
              <Textarea
                ...
                onChange={(e) =>
                  setFormData({ ...formData, virtue: e.target.value })
                }
                rows={2}
              />
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="flex gap-2">
                <Input
                  ...
                  onKeyPress={(e) =>
                    e.key === "Enter" && (e.preventDefault(), addAmal())
                  }
                />
                <Button type="button" onClick={addAmal}>
                  Add
                </Button>
              </div>
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setFormData({ ...formData, quranreference: e.target.value })
                  }
                />
              </div>
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setFormData({
                      ...formData,
                      hadithreference: e.target.value,
                    })
                  }
                />
              </div>
