        ...
        <DialogContent className="max-w-lg dark:bg-gray-800">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <DialogFooter>
              ...
              <Button type="submit" disabled={createPaymentPlatform.isPending || updatePaymentPlatform.isPending} className="bg-blue-600"><Save className="w-4 h-4 mr-2" />{translate('Save')}</Button>
            </DialogFooter>
          </form>
        </DialogContent>
      </Dialog>
