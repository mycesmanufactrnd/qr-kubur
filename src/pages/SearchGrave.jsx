      ...
      <Card className="border-0 shadow-sm dark:bg-gray-800">
        <CardContent className="p-3 space-y-2">
          <Input
            ...
            className="dark:bg-gray-700 dark:text-white dark:border-gray-600 dark:focus-visible:ring-white dark:focus-visible:ring-2 dark:focus-visible:ring-offset-0 h-9"
          />
