  ...
  const quickStats = [
    {
      ...
      cardGradient: "from-emerald-50 to-teal-50 dark:from-emerald-900/20 dark:to-teal-900/20",
    ...
    },
    {
      ...
      loading: isOGDSLoading,
      cardGradient: "from-violet-50 to-purple-50 dark:from-violet-900/20 dark:to-purple-900/20",
      iconGradient: "from-violet-500 to-purple-500",
      textGradient: "from-violet-600 to-purple-600 dark:from-violet-400 dark:to-purple-400",
  ...
  const deathCharity = [
    {
      ...
      cardGradient: "from-amber-50 to-red-50 dark:from-amber-900/20 dark:to-red-900/20",
      iconGradient: "from-amber-500 to-red-500",
      textGradient: "from-amber-600 to-red-600 dark:from-amber-400 dark:to-red-400",
    ...
    },
    {
      ...
      loading: isCMCLoading,
      cardGradient: "from-orange-50 to-blue-50 dark:from-orange-900/20 dark:to-blue-900/20",
      iconGradient: "from-orange-500 to-blue-500",
      textGradient: "from-orange-600 to-blue-600 dark:from-orange-400 dark:to-blue-400",
    ...
    },
    {
      ...
      loading: isCMCLoading,
      key: "money",
      cardGradient: "from-green-50 to-red-50 dark:from-green-900/20 dark:to-red-900/20",
      iconGradient: "from-green-500 to-red-500",
      textGradient: "from-green-600 to-red-600 dark:from-green-400 dark:to-red-400",
  ...
  const quotations = [
    {
      ...
      cardGradient: "from-sky-50 to-blue-50 dark:from-sky-900/20 dark:to-blue-900/20",
      iconGradient: "from-sky-500 to-blue-500",
      textGradient: "from-sky-600 to-blue-600 dark:from-sky-400 dark:to-blue-400",
    ...
    },
    {
      ...
      page: "ManageQuotations",
      loading: isQUOLoading,
      cardGradient: "from-teal-50 to-green-50 dark:from-teal-900/20 dark:to-green-900/20",
      iconGradient: "from-teal-500 to-green-500",
      textGradient: "from-teal-600 to-green-600 dark:from-teal-400 dark:to-green-400",
    ...
    },
    {
      ...
      loading: isQUOLoading,
      key: "money",
      cardGradient: "from-indigo-50 to-violet-50 dark:from-indigo-900/20 dark:to-violet-900/20",
