  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6 h-screen flex flex-col pb-10">
      ...
      <div className="flex-1 bg-white dark:bg-slate-800 rounded-lg shadow-md overflow-auto p-6 space-y-6 text-gray-700 dark:text-slate-300">
        ...
        <h2 className="text-xl font-semibold dark:text-slate-200 mt-4">1. Information We Collect</h2>

        <h3 className="text-lg font-semibold dark:text-slate-200 mt-4">1.1 Personal Information You Provide</h3>
        <p className="mb-4">
        ...
        <h3 className="text-lg font-semibold dark:text-slate-200 mt-4">1.2 Social Login Information</h3>
        <p className="mb-4">
        ...
        <h3 className="text-lg font-semibold dark:text-slate-200 mt-4">1.3 Automatically Collected and Tracking Information</h3>
        <p className="mb-4">
        ...
        <h3 className="text-lg font-semibold dark:text-slate-200 mt-4">1.4 Location Information</h3>
        <p className="mb-4">
        ...
        <h2 className="text-xl font-semibold dark:text-slate-200 mt-6">2. How We Use Your Information</h2>
        <p className="mb-4">
        ...
        <h2 className="text-xl font-semibold dark:text-slate-200 mt-6">3. Email Communications</h2>
        <p className="mb-4">
        ...
        <h2 className="text-xl font-semibold dark:text-slate-200 mt-6">4. Advertising</h2>
        <p className="mb-4">
        ...
        <h2 className="text-xl font-semibold dark:text-slate-200 mt-6">5. Payments and Transactions</h2>
        <p className="mb-4">
        ...
        <h2 className="text-xl font-semibold dark:text-slate-200 mt-6">6. Compliance with Malaysian Law</h2>
        <p className="mb-4">
        ...
        <h2 className="text-xl font-semibold dark:text-slate-200 mt-6">7. Sharing and Disclosure of Information</h2>
        <p className="mb-4">
        ...
        <h2 className="text-xl font-semibold dark:text-slate-200 mt-6">8. Data Security</h2>
        <p className="mb-4">
        ...
        <h2 className="text-xl font-semibold dark:text-slate-200 mt-6">9. Data Retention</h2>
        <p className="mb-4">
        ...
        <h2 className="text-xl font-semibold dark:text-slate-200 mt-6">10. User Rights and Choices</h2>
        <p className="mb-4">
        ...
        <h2 className="text-xl font-semibold dark:text-slate-200 mt-6">11. Changes to This Privacy Policy</h2>
        <p className="mb-4">
        ...
        <h2 className="text-xl font-semibold dark:text-slate-200 mt-6">12. Contact Information</h2>
