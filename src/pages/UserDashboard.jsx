...
export default function UserDashboard() {
  const quickActions = [
    ...
    { icon: FileText, title: translate('Semak Status Tahlil'), page: 'CheckTahlilStatus', color: 'bg-indigo-100 text-indigo-600 dark:bg-indigo-900 dark:text-indigo-300' },
  ...
  return (
    <div className="space-y-4 pb-2">
      <div className="pt-2">
        ...
        <p className="text-sm text-gray-500 dark:text-gray-400">{translate('Sistem Pencarian Kubur')}</p>
      </div>
