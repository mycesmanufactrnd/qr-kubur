    ...
    <div className="bg-white rounded-2xl border border-slate-100 shadow-sm overflow-hidden">
      ...
      <div className="p-4 space-y-2">
        <div className="flex items-start justify-between gap-2">
          ...
          {item.state && (
            <span className="shrink-0 bg-amber-100 text-amber-700 text-xs rounded-lg px-2 py-0.5">
              {item.state}
            </span>
          )}
        </div>
      ...
      <div className="flex-1 overflow-y-auto px-4 py-4 space-y-6 pb-28">
        ...
        <FormSection title={translate("Services")}>
            ...
            {serviceEntries.map((entry) => {
              ...
              return (
                <div key={entry.id} className="flex items-center gap-2">
                  <input
                    className="flex-1 h-10 rounded-xl border border-slate-200 px-3 text-sm focus:outline-none focus:ring-2 focus:ring-amber-300 disabled:bg-slate-50 disabled:text-slate-400"
                  ...
                  />
                  <input
                    className="w-20 h-10 rounded-xl border border-slate-200 px-2 text-sm text-center focus:outline-none focus:ring-2 focus:ring-amber-300"
                    type="number"
                    step="0.01"
                    placeholder="RM"
                    value={entry.price}
                  ...
                  {!isLocked && (
                    <button
                      ...
                      className="w-10 h-10 flex items-center justify-center text-red-500 rounded-xl border border-red-100 shrink-0"
                    >
                      <X className="w-4 h-4" />
                    </button>
                  )}
          ...
          <button
            ...
            className="flex items-center gap-1.5 text-xs text-amber-600 border border-amber-200 rounded-lg px-3 py-2 active:opacity-70"
          >
        ...
        <FormSection title={translate("Contact & Location")}>
          ...
          <button
            ...
            disabled={isLocating}
            className="w-full h-11 rounded-xl border border-slate-200 text-slate-600 text-sm flex items-center justify-center gap-2 active:opacity-70 disabled:opacity-50"
          >
          ...
          <FormSection title={translate("Payment Config")}>
            ...
            {selectedPaymentPlatforms.map((platformCode) => {
              ...
              return (
                <div
                  key={platformCode}
                  className="bg-amber-50 rounded-xl border border-amber-100 p-3 space-y-3"
                >
                    ...
                    return (
                      <div key={field.id}>
                        ...
                        <input
                          ...
                          className="w-full h-10 rounded-xl border border-slate-200 px-3 text-sm focus:outline-none focus:ring-2 focus:ring-amber-300"
                          value={value}
            ...
            <div className="flex gap-2">
              ...
              {editingUserIndex !== null && (
                <button
                  ...
                  className="h-10 px-4 rounded-xl border border-slate-200 text-slate-600 text-xs font-medium active:opacity-80"
                >
                  {translate("Cancel")}
                </button>
              )}
                ...
                {userEntries.map((entry, index) => (
                  ...
                  >
                    ...
                    <button
                      ...
                      className="w-8 h-8 flex items-center justify-center text-amber-600 rounded-lg border border-amber-200 active:opacity-70"
                    >
                      <Edit className="w-3.5 h-3.5" />
                    </button>
                    <button
