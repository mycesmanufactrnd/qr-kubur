  ...
  const quickActions = [
    ...
    ...(isOrgCanManageMosque
      ? [
          ...
          {
            label: translate("Activity Posts"),
            ...
            <div className="grid grid-cols-2 gap-2.5 mb-5">
              ...
              >
                <div className="rounded-2xl p-3.5 bg-rose-50 dark:bg-rose-900/20 border border-slate-100 dark:border-slate-600/5 h-full">
                  ...
                  <p className="text-[11px] font-medium leading-tight mb-1 text-slate-500 dark:text-slate-400">
          ...
          {quickActions.map((a, i) => (
            ...
            >
              <div className="flex items-center gap-3 px-3.5 py-3 border-b border-slate-100 dark:border-slate-700 last:border-b-0">
                <div
                  className={`w-8 h-8 rounded-xl flex items-center justify-center shrink-0 ${colorMap[a.color]?.icon ?? colorMap.blue.icon}`}
                >
                  <a.icon
                    size={14}
                    className={
                      colorMap[a.color]?.iconText ?? colorMap.blue.iconText
                    }
                  />
                </div>
                <span className="text-[14px] text-slate-700 dark:text-slate-200 flex-1 font-medium">
                  {a.label}
                </span>
                <ChevronRight
                  size={15}
    ...
    >
      ...
      >
        ...
        <div>
          ...
          <p
            className={`font-bold leading-none tracking-tight ${isMoney ? "text-[17px]" : "text-[22px]"} ${c.value}`}
          >
            {loading ? (
