...
export const runBucketSeeder = async () => {
  ...
  const sql = `
    ...
    ('bucket-organisation', 'Organisation Images', 'qr-kubur', 'local',
    '{"image/png","image/jpeg","image/jpg","image/gif","image/webp"}',
    107374182400, true),
    ...
    ('bucket-organisation-services-proof', 'Organisation Services Proof', 'qr-kubur', 'local',
    '{"image/png","image/jpeg","image/jpg","image/gif","image/webp"}',
    107374182400, true),
    ...
    ('bucket-grave-service-quotation', 'Grave Service Quotation', 'qr-kubur', 'local',
    '{"image/png","image/jpeg","image/jpg","image/gif","image/webp"}',
    107374182400, true)
